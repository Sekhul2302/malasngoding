    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">Portal Apps QA Testing v.1</a>
            </div>
            <!-- /.navbar-header -->
                    ...
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="flot.html">DM Core</a>
                                </li>
                                <li>
                                    <a href="morris.html">DM Non Core</a>
                                </li>
                                <li>
                                    <a href="morris.html">DM Special Project</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
                        ...
                        <li>
                            ...
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="<?=base_url();?>core">Core</a>
                                </li>
                                <li>
                                    <a href="<?=base_url();?>noncore">Non core</a>
                                </li>
                                <li>
                                    <a href="<?=base_url();?>spesialproject">Special Project</a>
                                </li>
                                <li>
                                    <a href="typography.html">Database QA</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
